...
public class User {
	...
	public String toString() {
		return "User [id=" + id + ", userName=" + userName + ", fullName=" + fullName + ", email=" + email
				+ ", password=" + password + ", primaryMobile=" + primaryMobile + ", secondaryMobile=" + secondaryMobile
				+ ", dob=" + dob + ", age=" + age + ", gender=" + gender + ", refferalType=" + refferalType
				+ ", refferalInfo=" + refferalInfo + ", address=" + address + ", city=" + city + ", state=" + state
				+ ", createdOn=" + createdOn + ", modifiedOn=" + modifiedOn + ", deletes=" + deletes + ", status="
